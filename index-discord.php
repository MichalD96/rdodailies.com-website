...
<?php require_once './assets/inc/discord-invite.php' ?>
			<iframe src="https://discord.com/widget?id=755631770480803931&theme=dark" width="610" height="240" allowtransparency="true" frameborder="0" sandbox="allow-popups allow-popups-to-escape-sandbox allow-same-origin allow-scripts"></iframe>
  </div>
