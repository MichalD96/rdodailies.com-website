...
?>   
		<div class="challenge-input-container">
			<span class="daily-challenge">
                <span class="goal"><?php echo $GeneralChallengeGoal; ?></span>
			
                <span class="challenge">
			<label id="GeneralChallenge<?php echo $GeneralChallengeNumber; ?>" for="GeneralChallenge<?php echo $GeneralChallengeNumber; ?>-<?php echo $DailyChallengeDate; ?>"><? echo strtok($GeneralChallenge, '[{'); ?></label>
                    </span>
			</span>
