<!-- ES6 Compatibility Check -->
  ...
  <script src="/assets/js/dailies-rank.js?nocache=<?php echo $nocache; ?>"></script>
  <script src="/assets/js/dailies.js?nocache=<?php echo $nocache; ?>"></script>
  <script src="/assets/js/counters.js?nocache=<?php echo $nocache2; ?>"></script>
  <script src="/assets/js/popup-modal.js?nocache=<?php echo $nocache2; ?>"></script>
