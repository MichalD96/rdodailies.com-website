const updateTime = '6:00:55'; // UTC update time - if server update is slow you can increase it by a few mins or seconds 'hours:minutes:seconds' to reload when server data will be updated
